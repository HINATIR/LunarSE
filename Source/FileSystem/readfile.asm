0x52A5D0 ; wchar_t readFile(wchar_t filepath, temp)
...
B.EQ _FileReadEnd
CMP W0, #0xD
B.EQ _FileReadLoop ; ignoreCarriageReturn
CMP W0, #0xA
B.NE _noNewLine ; change newLine to NullString
MOV W0, #0
STR W0, [X22] <= _noNewLine
ADD X22, X22, #4
B _FileReadLoop
